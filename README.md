...
Gemini said
Got it. Let’s keep it focused on the project structure, logic flow, and features so the README explains what your API does and why it works that way, rather than just dumping the code back at you.

Here is a conceptual, high-level README for your ThemeContext API:
